...
export const projects: Project[] = [
  ...
  },
  {
    ...
    link: 'https://theyogicbowl.vercel.app/',
    category: 'Web Application',
  ...
  },
  {
    slug: 'dev-store',
    title: 'Dev Store',
    video: 'https://pub-ab1090e7d272462f9dcdf859626e7687.r2.dev/dev-store.mp4',
    link: 'https://store.chhavii.in/',
    category: 'Web Application',
    source: 'https://github.com/chhavipaliwal/dev-store',
    technologies: ['tabler:brand-nextjs', 'tabler:brand-tailwind'],
    tagline: 'A centralized hub for free and essential development resources.',
    description:
      'DevStore, a modern platform for developers and designers to organize, categorize, and access essential free web resources efficiently',
  },
  {
