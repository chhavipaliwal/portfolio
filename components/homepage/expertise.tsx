...
const expertise: Expertise[] = [
  ...
  },
  {
    ...
    items: ['Node.js', 'Express.js', 'Authentication', 'RESTful Services', 'Server-Side Logic'],
    color: 'hover:bg-[#d4e2db]',
  },
  {
    id: '03',
    title: 'UI/UX Design',
    items: ['User-Centered Design', 'Wireframing', 'Prototyping', 'Figma', 'Interaction Design'],
    color: 'hover:bg-[#DFDACD]',
  },
  {
    id: '04',
    title: 'Database & API Integration',
    items: ['MongoDB', 'Mongoose', 'Firebase', 'REST API Integration', 'Data Modeling'],
...
export default function Expertise() {
  return (
    <section className="-translate-y-48 rounded-t-[74px] bg-white py-28 font-neue-Helvetica-Condensed-light tracking-wider dark:bg-black">
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        ...
        >
          <Link href="/contact">
            <Button className="border border-background font-neue-Helvetica-Medium font-semibold text-background">
              discuss the project
            </Button>
          </Link>
        </motion.div>
