...
const HeroSection = () => {
  return (
    <section className="relative flex min-h-screen items-center justify-center">
      ...
      {/* Overlay Content */}
      <div className="relative z-10 flex w-full max-w-7xl flex-col justify-between p-8 text-white md:flex-row">
        ...
        <div className="max-w-lg">
          ...
          <div className="mt-6 flex items-center space-x-3">
            ...
            >
              <svg
                className="h-5 w-5 rounded-full border border-white text-white"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <div className="max-w-sm md:mt-0 md:text-right">
